...
L = [
 ...
 ("people","people",6,"city","Pittsburgh",None,[-79.99,40.44],
  "has as many <b>city employees</b> as <b class=k>Pittsburgh</b> has people","307,247","307,632",
  "Authorized full-time positions. Bodies on the payroll were 291,717 in April 2026.",
  "Authorized full-time headcount for fiscal 2026 in the February 2026 Financial Plan, as cited by the city Comptroller; actual full-time employees in April 2026 were 291,717 (ratio to Pittsburgh 1.055). Pittsburgh is the Census Bureau's Vintage 2025 estimate as summarized by the University of Pittsburgh's Center for Social and Urban Research."),
 ("people","people",8,"city","Cleveland",None,[-81.69,41.50],
  "houses as many <b>people in public housing</b> as live in <b class=k>Cleveland</b>","344,661","363,608",
  "Authorized residents in Section 9 and converted developments; NYCHA says about 400,000 people actually live in its buildings.",
 ...
 ("money","money",3,"country","Iraq",None,None,
  "spends as much on its <b>police department</b> as <b class=k>Iraq</b> spends on its military","$6.59 billion","$6.4 billion",
 ...
 ("money","money",4,"country","Iceland",None,None,
  "spends as much on <b>public schools</b> as <b class=k>Iceland</b> produces in a year","$37.9 billion","$38.6 billion",
 ...
 ("money","money",5,"company","Starbucks (Seattle)","Starbucks",[-122.33,47.61],
  ...
  None,"Comptroller's forecast of fiscal 2027 property tax revenue; Starbucks' consolidated net revenues for fiscal 2025 from its earnings release."),
 ("money","money",6,"country","Tunisia",None,None,
  ...
  None,"Direct visitor spending in 2025 per New York City Tourism + Conventions' annual report (total economic impact was $84.7 billion); IMF estimate of Tunisia's 2025 nominal GDP."),
 ...
 ("money","money",10,"country","Spain",None,None,
  ...
  "Department of Finance market values are the city's own estimates and lag actual sale prices.",
 ...
 ("safety","crime",0,"city","Houston",None,[-95.37,29.76],
  "has as many <b>murders a year</b> as <b class=k>Houston</b>","305","272",
 ...
 ("movement","transit",0,"city","Hong Kong",None,[114.17,22.32],
  "runs as many <b>public buses</b> as <b class=k>Hong Kong</b>'s five franchised bus companies","5,800","5,870",
  None,"MTA's New York City Transit page (2023 fleet); sum of the five franchised operators' fleets in the Hong Kong government's July 2025 transport fact sheet (3,895 + 1,326 + 226 + 281 + 142). Whether the MTA's 5,800 includes the MTA Bus Company is not stated on the page."),
 ...
 ("movement","transit",3,"region","European Union",None,[4.35,50.85],
  "gives as many <b>bus rides a year</b> as the <b class=k>European Union</b> has people","442 million","450 million",
 ...
 ("movement","transit",6,"country","Russia",None,[37.62,55.75],
  "moves as many <b>airline passengers a year</b> as <b class=k>Russia</b> has people","142.7 million","143.7 million",
  "Counts Kennedy, LaGuardia and Newark, which is in New Jersey, plus Stewart.","Combined 2025 passengers at JFK, Newark, LaGuardia and Stewart, per the Port Authority as reported by AviationPros; World Bank 2024 population for Russia."),
 ("movement","transit",7,"city","London",None,[-0.12,51.5],
  "has as many <b>yellow cabs</b> as <b class=k>London</b> has black cabs","13,587","13,483",
  None,"Taxi and Limousine Commission (the medallion count is fixed by law); Transport for London licensing figures for the week ending Aug. 16, 2026."),
 ...
 ("place","land",6,"state","Rhode Island",None,[-71.5,41.7],
  ...
  "Definitions differ: the city counts its own bridge and tunnel structures; the federal count is bridges over 20 feet on public roads.",
 ...
 ("people","learning",3,"country","Ireland",None,None,
  "employs as many <b>public school teachers</b> as all of <b class=k>Ireland</b>","over 77,000","74,073",
  None,"Mayor's Management Report, fiscal 2025 Department of Education chapter; Ireland's Department of Education 2022 teacher count from its March 2024 indicators report. Ireland has hired since, so the gap is probably narrower."),
 ...
 ("money","wealth",9,"country","Slovakia","Slovakia",None,
  ...
  None,"Bureau of Economic Analysis 2024 GDP for Kings County via FRED; IMF figure for Slovakia's 2024 nominal GDP."),
 ("money","wealth",5,"country","Ethiopia",None,None,
  ...
  "Holds for 2024 only: Ethiopia's dollar GDP fell by a quarter in 2025 after a devaluation.",
 ...
 ("money","wealth",6,"country","Jordan",None,None,
  ...
  None,"Bureau of Economic Analysis 2024 GDP for Bronx County via FRED; IMF figure for Jordan's 2024 nominal GDP."),
 ...
 ("life","daily",7,"country","Indonesia",None,[106.85,-6.2],
  "speaks as many <b>languages</b> as <b class=k>Indonesia</b>","700-plus","710",
  "The city count is language varieties across the metro area; Indonesia's is distinct living languages.",
