...
const REVENUE_OPTIONS = [
  ...
  { id: 'corporate_tax', label: 'Raise corporate tax on top firms', amount: 1500, category: 'tax_increase', difficulty: 'hard', desc: 'The state Senate\'s one-house budget (March 2026) would authorize NYC to raise corporate taxes: financial sector from 9% to 10.8%, non-finance from 8.85% to 10.62%, plus UBT from 4% to 4.4% on income over $5 million. As of early April, the mayor is reportedly negotiating a more modest package than the Senate\'s full authorization.', source: 'NYS Senate one-house budget (March 10, 2026); NYT (April 1, 2026)', sourceUrl: 'https://www.nysenate.gov/newsroom/press-releases/2026/new-york-state-senate-advances-2026-one-house-budget-resolution', risk: 'Manhattan Chamber warns of competitiveness risk. Requires Albany — governor has not endorsed it. Mamdani may settle for less than the full $1.5 billion.', conflicts: [] },
    ...
    <div className="act act--cloud" id="act-proposals">
      <div className="content-w">
        ...
        <div className="proposal-card">
          ...
          <p className="proposal-note">Council Speaker Menin called the property tax hike a "non-starter." Of the $1.77 billion savings target, ~$250 million has been approved. The administration has quietly identified another $1.3 billion — from delaying the class size mandate and scaling back CityFHEPS — but both require Albany or court approval. Governor Hochul demands real cuts before she’ll consider tax help.</p>
        </div>
        </FadeIn>
